...
这篇博客，主要是记录自己在学习过程中的一些想法和认识；另外也给出一个对 JavaScript 面向对象编程进行学习的主线，方便要对 JavaScript 面向对象编程进行学习的同学。

不过，建议要学的同学还是看[《全面理解面向对象的 JavaScript》][3]这篇文章，这是一篇非常好的文章，教程；相比之间，这里我写的这些东西，更多的还是记录自己的一些想法。
